...
# set vars
if [ ! $NODENAME ]; then
	read -p "Node İsminizi Yazınız: " NODENAME
...
echo -e "Chain Bilgisi: \e[1m\e[32m$GAIA_CHAIN_ID\e[0m"
echo -e "Port: \e[1m\e[32m$GAIA_PORT\e[0m"
echo '================================================='
sleep 2
...
echo -e "\e[1m\e[32m2. Yüklemeler Devam Ediyor... \e[0m" && sleep 1
# packages
...
echo -e 'Log Kontrol: \e[1m\e[32mjournalctl -u gaiad -f -o cat\e[0m'
echo -e "Sync Kontrol: \e[1m\e[32mcurl -s localhost:${GAIA_PORT}657/status | jq .result.sync_info\e[0m"
