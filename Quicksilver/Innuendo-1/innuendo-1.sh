...
# set vars
if [ ! $NODENAME ]; then
	read -p "Node İsminizi Yazın: " NODENAME
...
echo -e "Chain ID: \e[1m\e[32m$QUICKSILVER_CHAIN_ID\e[0m"
echo -e "Port Numaranız: \e[1m\e[32m$QUICKSILVER_PORT\e[0m"
echo '================================================='
sleep 2
...
echo -e "\e[1m\e[32m2. Yükleme Devam Ediyor... \e[0m" && sleep 1
# packages
...
echo -e "\e[1m\e[32m3. Binary Dosyası İndiriliyor... \e[0m" && sleep 1
# download binary
cd $HOME
rm quicksilver -rf
...
echo -e 'Log Kontrol: \e[1m\e[32mjournalctl -u quicksilverd -f -o cat\e[0m'
echo -e "Sync Komutu: \e[1m\e[32mcurl -s localhost:${QUICKSILVER_PORT}657/status | jq .result.sync_info\e[0m"
