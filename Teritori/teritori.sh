...
echo -e "Ağ bilgisi: \e[1m\e[32m$TERITORI_CHAIN_ID\e[0m"
echo -e "Port: \e[1m\e[32m$TERITORI_PORT\e[0m"
echo '================================================='
sleep 2

echo -e "\e[1m\e[32m1. Güncelleme Paketleri Yükleniyor... \e[0m" && sleep 1
# update
...
echo -e 'log kontrol: \e[1m\e[32mjournalctl -u teritorid -f -o cat\e[0m'
echo -e "sync durumu: \e[1m\e[32mcurl -s localhost:${TERITORI_PORT}657/status | jq .result.sync_info\e[0m"
