...
sleep 1 && curl -s https://raw.githubusercontent.com/brsbrc/Sei-Atlantic-1-Rehber/main/logo.sh | bash && sleep 1
...
echo -e "\e[1m\e[32m4 Kurulum Başarıyla Tamamlandı... \e[0m" && sleep 1


echo -e '\n\e[42mNode Durumu\e[0m\n' && sleep 1
if [[ `service seid status | grep active` =~ "running" ]]; then
  echo -e "Tebrikler, İşlem Başarılı \e[32mçalışıyor\e[39m!"
else
  echo -e "Tekrar Kurun"
fi
