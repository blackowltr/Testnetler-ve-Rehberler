echo -e "\e[1m\e[32mSui Full Node Güncelleniyor... \e[0m" && sleep 1
systemctl stop suid
...
echo -e "\e[1m\e[32mSui Full Node Başarıyla Güncellendi...\e[0m" && sleep 1
echo -e "\e[1m\e[32mVersion 0.7.0\e[0m" && sleep 1
