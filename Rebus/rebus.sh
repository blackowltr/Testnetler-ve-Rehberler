...
echo -e "Chain id: \e[1m\e[32m$REBUS_CHAIN_ID\e[0m"
echo -e "Port: \e[1m\e[32m$REBUS_PORT\e[0m"
echo '================================================='
sleep 2
...
echo -e "\e[1m\e[32m3. Binary kurulumu yapılıyor... \e[0m" && sleep 1
# download binary
cd $HOME
...
echo '=============== Tebrikler, Kurulum Başarıyla Tamamlandı ==================='
echo -e 'Log kontrol için: \e[1m\e[32mjournalctl -u rebusd -f -o cat\e[0m'
echo -e "Sync durumu için: \e[1m\e[32mcurl -s localhost:${REBUS_PORT}657/status | jq .result.sync_info\e[0m"
